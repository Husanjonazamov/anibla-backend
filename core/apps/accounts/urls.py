...
from .views import RegisterView, ResetPasswordView, MeView, ChangePasswordView, ActorprofileView, DirectorView
...
router.register("director", DirectorView, basename="auth-director")
